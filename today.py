...
if __name__ == '__main__':
    ...
    # e.g {'id': 'MDQ6VXNlcjczOTcwNTE5'} and 2020-11-04T23:08:44Z for username 'jonatasperaza'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2007, 10, 27))
    ...
    if OWNER_ID == {'id': 'MDQ6VXNlcjU3MzMxMTM0'}: # upstream owner (Andrew6rant) only - the archived data below belongs to that account
